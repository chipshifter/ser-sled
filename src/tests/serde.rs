...
mod relaxed_serde_tests {
    ...
    fn insert_and_get() {
        ...
        let tree = ser_db
            .open_relaxed_serde_tree("insert_and_get")
    ...
    fn get_or_init() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_relaxed_serde_tree("get_or_init")
            .expect("tree should open");
    ...
    fn first_and_last() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_relaxed_serde_tree("first_and_last")
            .expect("tree should open");
    ...
    fn is_binary_order_preserved() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_relaxed_serde_tree("binary_order")
            .expect("tree should open");
    ...
    fn contains_key() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_relaxed_serde_tree("contains_key")
            .expect("tree should open");
    ...
    fn pop_max() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_relaxed_serde_tree("pop_max")
            .expect("tree should open");
    ...
    fn remove() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_relaxed_serde_tree("remove")
            .expect("tree should open");
...
mod strict_serde_tests {
    ...
    fn insert_and_get() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_serde_tree::<Vec<u8>, Vec<u8>>("insert_and_get")
            .expect("tree should open");
    ...
    fn get_or_init() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_serde_tree::<Vec<u8>, Vec<u8>>("get_or_init")
            .expect("tree should open");
    ...
    fn first_and_last() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_serde_tree::<[u8; 1], Vec<u8>>("first_and_last")
            .expect("tree should open");
    ...
    fn iter() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_serde_tree::<[u8; 1], Vec<u8>>("iter")
            .expect("tree should open");
    ...
    fn range_key_bytes() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_serde_tree::<[u8; 1], Vec<u8>>("range")
            .expect("tree should open");
    ...
    fn range() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_serde_tree::<u64, Vec<u8>>("range")
            .expect("tree should open");
    ...
    fn is_binary_order_preserved() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_serde_tree::<[u8; 1], [u8; 1]>("binary_order")
            .expect("tree should open");
    ...
    fn clear() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_serde_tree::<[u8; 1], [u8; 1]>("clear")
            .expect("tree should open");
    ...
    fn contains_key() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_serde_tree::<[u8; 1], [u8; 1]>("contains_key")
            .expect("tree should open");
    ...
    fn pop_max() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_serde_tree::<[u8; 1], [u8; 1]>("pop_max")
            .expect("tree should open");
    ...
    fn remove() {
        ...
        let ser_db: Db = db.into();
        let tree = ser_db
            .open_serde_tree::<[u8; 1], [u8; 1]>("remove")
            .expect("tree should open");
